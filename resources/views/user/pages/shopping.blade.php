      ...
      <div class="cart-info">
        <table class="table table-striped table-bordered">
          ...
          <tr>
            ...
            <td  class="name"><a href="#">{!! $item["name"] !!}</td>
            <td class="quantity">
              <input class="span1 qty" type="text" size="1" value='{!! $item["qty"] !!}' name="quantity[40]">
             </td>
             <td class="total">
             <a href="#" class="update-cart" id="{!! $item['rowid'] !!}"><img class="tooltip-test" data-original-title="Update" src="{!! asset('public/user/img/update.png') !!}" alt=""></a>
              <a href="{!! URL::route('xoasanpham',['id'=>$item['rowid']]) !!}"><img class="tooltip-test" data-original-title="Remove"  src="{!! asset('public/user/img/remove.png') !!}" alt=""></a>
            </td>
